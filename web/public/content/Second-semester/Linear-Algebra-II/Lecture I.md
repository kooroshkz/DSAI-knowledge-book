...
|----------------|------------|-----------------------------------------------------------------------|-------------------------------------------|
| Span           | Span{u}    | Set of all possible linear combinations of `u`                       | If
...
$$\left\{ \begin{bmatrix} a - 3b \\ 2b \\ -a + 7b \\ b \end{bmatrix} \in \mathbb{R}^4 : a, b \in \mathbb{R} \right\}$$
...
If $v_1, v_2,... \in$ Vector space V$show span{$v_1, v_2,..$.} is subspace of V assume$W$= span{$v_1, v_2,..$.} - <ins>0</ins> = <ins>0</ins>$v_1$+ <ins>0</ins>$v_2$$\in W$-$a_1.\underline{v_1}$+$a_2.\underline{v_2}$+$b_1.\underline{v_1}$+$b_2.\underline{v_2}$= ($a_1 + b_1$)$\underline{v_1}$$\in W$- c($a_1.\underline{v_1}$+$a_2.\underline{v_2}$) =$(c a_1 )\underline{v_1}$+$(c a_2 )\underline{v_2}$$\in W$**Head up** W =$\left\{ \begin{bmatrix} a + b \\ b \\ 1 \end{bmatrix} \in \mathbb{R}^3 , a, b \in \mathbb{R} \right\}$$W$is **not** in subspace$\mathbb{R}^3$due:$\begin{bmatrix} a_1 + b_1 \\ b_1 \\ 1 \end{bmatrix}$+$\begin{bmatrix} a_2 + b_2 \\ b_2 \\ 1 \end{bmatrix}$=$\begin{bmatrix} a_1 + b_1 + a_2 + b_2 \\ b_1 + b_2 \\ 2 \end{bmatrix}$then$2 \neq 1$also it doesnt contain zero vector for any$a, b$
<hr>
